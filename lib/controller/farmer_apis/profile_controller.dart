...
class FarmProfileController extends GetxController {
  ...
  final String baseUrl = '${AppContants.baseUrl}/farmers'; // Replace with your base URL
  ...
  Future<void> getUserProfile() async {
    ...
    final farmertoken = await _getToken();
    print('Token fetched from SharedPreferences: $farmertoken');
    final headers = {
      'Content-Type': 'application/json',
      'Authorization': farmertoken, // Use token from SharedPreferences
    };
    try {
      ...
      if (response.statusCode == 200) {
        ...
        orders.clear();
        favorites.clear();
        print('Failed to load farmer profile: ${response.body}');
      }
    } catch (e) {
      print('Error: $e');
      userProfile.value = {};
